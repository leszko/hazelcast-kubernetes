...
public class DefaultKubernetesClientTest {
    ...
    private static final String IP_1 = "192.168.0.25";
    private static final String IP_2 = "172.17.0.5";
    private static final String NOT_READY_IP = "172.17.0.6";
    private static final String PUBLIC_IP = "35.232.226.200";
    private static final Integer PORT_1 = 5701;
    private static final Integer PORT_2 = 5702;
    private static final String IP_PORT_1 = ipPort(IP_1, PORT_1);
    private static final String IP_PORT_2 = ipPort(IP_2, PORT_2);
    private static final String NOT_READY_IP_PORT = ipPort(NOT_READY_IP, null);
    private static final String POD_NAME = "my-release-hazelcast-0";
    ...
    public void endpointsByNamespace() {
        ...
        // then
        assertThat(extractIpPort(result.getAddresses()), containsInAnyOrder(IP_PORT_1, IP_PORT_2));
        assertThat(extractIpPort(result.getNotReadyAddresses()), containsInAnyOrder(NOT_READY_IP_PORT));
    }
    ...
    public void zoneBeta() {
        ...
        stubFor(get(urlPathMatching(String.format("/api/v1/namespaces/%s/pods/%s", NAMESPACE, POD_NAME)))
                .withHeader("Authorization", equalTo(String.format("Bearer %s", TOKEN)))
        ...
        // when
        String zone = kubernetesClient.zone(NAMESPACE, POD_NAME);
    ...
    private static String podsListBody() {
        return String.format("{\n"
                ...
                + "    }\n"
                + "  ]\n"
                + "}", PORT_1, IP_1, PORT_2, IP_2, NOT_READY_IP);
    }
    ...
    private static String endpointsListBody() {
        return String.format(
                "{" +
                        ...
                        "  ]" +
                        "}"
                , IP_1, PORT_1, IP_2, PORT_2, NOT_READY_IP);
    }
    ...
    private static String endpointsPublicIpBody() {
        return "{\n"
                + "  \"kind\": \"EndpointsList\",\n"
                + "  \"apiVersion\": \"v1\",\n"
                + "  \"metadata\": {\n"
                ...
                + "            {\n"
                + "              \"ip\": \"10.16.0.7\",\n"
                + "              \"nodeName\": \"gke-rafal-test-cluster-default-pool-7053600e-xd63\",\n"
                + "              \"targetRef\": {\n"
                + "                \"kind\": \"Pod\",\n"
                + "                \"namespace\": \"default\",\n"
                + "                \"name\": \"my-release-hazelcast-0\",\n"
                ...
                + "            {\n"
                + "              \"ip\": \"10.16.1.7\",\n"
                + "              \"nodeName\": \"gke-rafal-test-cluster-default-pool-7053600e-pvnt\",\n"
                + "              \"targetRef\": {\n"
                + "                \"kind\": \"Pod\",\n"
                + "                \"namespace\": \"default\",\n"
                + "                \"name\": \"my-release-hazelcast-1\",\n"
